...
\frame
{
  \centerline{\includemovie[autoplay,loop,text={\includegraphics[height=.78\textheight]{figures/sphere_cavity/LD_2.0/P}}]{}{.8\textheight}{movies/P_small.avi}}  
}

\frame
{
  \centerline{\includemovie[autoplay,loop,text={\includegraphics[height=.78\textheight]{figures/sphere_cavity/LD_2.0/T}}]{}{.8\textheight}{movies/T_small.avi}}  
}
...
\frame
{
  %\frametitle{\scriptsize Drop Tests}
  \vspace{-2em}
  \begin{center}
